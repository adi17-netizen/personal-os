  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        {/* Heading */}
        <h1 className="text-center text-2xl font-semibold text-white tracking-tight mb-2">
          Personal OS
        </h1>
        <p className="text-center text-gray-400 text-sm mb-8 leading-relaxed">
          Your entire Google life. One screen.
        </p>
        ...
        <div className="bg-card border border-border rounded-2xl p-6 flex flex-col gap-4">
          ...
          <button
            ...
            disabled={loading}
            className="flex items-center justify-center gap-3 w-full py-3 px-4 bg-white hover:bg-gray-100 text-gray-800 font-medium rounded-xl transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
          >
            {loading ? (
          ...
          <div className="text-[11px] text-gray-600 text-center leading-relaxed">
            Personal OS requests access to your Calendar, Tasks, and Drive
            so widgets can display your live data.
          </div>
        </div>
